...
/* ============================================================
   MODIFIER GROUPS
   Reusable option sets referenced by id from items below via
   `modifiers: ["group_id"]`. "price" is the amount ADDED to the
   base dish price when that option is chosen (0 = no extra cost).
   ============================================================ */
const MODIFIER_GROUPS = {
  guarnicion: {
    ...
    options: [
      ...
      { id: "arroz_vegetal", label: "Arroz solo vegetal", price: 0 },
      { id: "arroz_jamon", label: "Arroz solo jamón", price: 0 },
      { id: "arroz_cerdo", label: "Arroz solo cerdo", price: 0 }
    ]
  }
};
...
const MENU = [
  ...
  },
  {
    ...
    items: [
      ...
      { no: 34, id: "p03", name: "Pollo con Pepper", price: 0.00, modifiers: ["guarnicion"] },
      { no: 35, id: "p04", name: "Pollo al Ajillo", price: 0.00, modifiers: ["guarnicion"] },
      { no: 36, id: "p05", name: "Pollo Agridulce", price: 0.00, modifiers: ["guarnicion"] },
      { no: 37, id: "p06", name: "Pollo Naranja", price: 0.00, modifiers: ["guarnicion"] },
      { no: 38, id: "p07", name: "Pollo Enchilado", price: 0.00, modifiers: ["guarnicion"] },
      { no: 39, id: "p08", name: "Pollo con Jengibre", price: 0.00, modifiers: ["guarnicion"] },
      { no: 40, id: "p09", name: "Pollo a la Plancha", price: 0.00, modifiers: ["guarnicion"] },
      { no: 41, id: "p10", name: "Pollo Con Setas", price: 0.00, modifiers: ["guarnicion"] },
      { no: 42, id: "p11", name: "Pollo con Curry", price: 0.00, modifiers: ["guarnicion"] },
      { no: 43, id: "p12", name: "Chow Suey de Pollo", price: 0.00, modifiers: ["guarnicion"] },
      { no: 44, id: "p13", name: "Egg Fu Young de Pollo", price: 0.00, modifiers: ["guarnicion"] }
    ]
  },
  {
    ...
    items: [
      ...
      { no: 47, id: "c03", name: "Carne Ahumada (sin hueso)", price: 0.00, modifiers: ["guarnicion"] },
      { no: 48, id: "c04", name: "Carne Ahumada en Salsa", price: 0.00, modifiers: ["guarnicion"] },
      { no: 49, id: "c05", name: "Chuleta Frita", price: 0.00, modifiers: ["guarnicion"] },
      { no: 50, id: "c06", name: "Carne Ahumada con Brocoli", price: 0.00, modifiers: ["guarnicion"] },
      { no: 51, id: "c07", name: "Carne Frita", price: 0.00, modifiers: ["guarnicion"] },
      { no: 52, id: "c08", name: "Chow Suey Ahumada", price: 0.00, modifiers: ["guarnicion"] }
    ]
  },
  {
    ...
    items: [
      ...
      { no: 55, id: "b03", name: "Res con Brocoli", price: 0.00, modifiers: ["guarnicion"] },
      { no: 56, id: "b04", name: "Res con Setas", price: 0.00, modifiers: ["guarnicion"] },
      { no: 57, id: "b05", name: "Res con Curry", price: 0.00, modifiers: ["guarnicion"] },
      { no: 58, id: "b06", name: "Chow Suey de Res", price: 0.00, modifiers: ["guarnicion"] },
      { no: 59, id: "b07", name: "Egg Fu Young de Res", price: 0.00, modifiers: ["guarnicion"] }
    ]
  },
  {
    ...
    items: [
      ...
      { no: 62, id: "m03", name: "Camarones en Salsa Langosta", price: 0.00, modifiers: ["guarnicion"] },
      { no: 63, id: "m04", name: "Camarones al Ajillo", price: 0.00, modifiers: ["guarnicion"] },
      { no: 64, id: "m05", name: "Camarones Enchilado", price: 0.00, modifiers: ["guarnicion"] },
      { no: 65, id: "m06", name: "Camarones Agridulce", price: 0.00, modifiers: ["guarnicion"] },
      { no: 66, id: "m07", name: "Camarones Fritos (4)", price: 0.00, modifiers: ["guarnicion"] },
      { no: 67, id: "m08", name: "Filete de Pescado al Ajillo", price: 0.00, modifiers: ["guarnicion"] },
      { no: 68, id: "m09", name: "Filete de Pescado con Brocoli", price: 0.00, modifiers: ["guarnicion"] },
      { no: 69, id: "m10", name: "Chow Suey de Camarones", price: 0.00, modifiers: ["guarnicion"] },
      { no: 70, id: "m11", name: "Egg Fu Young de Camarones", price: 0.00, modifiers: ["guarnicion"] },
      { no: 71, id: "m12", name: "Egg Fu Young Especial", price: 0.00, modifiers: ["guarnicion"] },
      { no: 72, id: "m13", name: "Chow Suey Especial", price: 0.00, modifiers: ["guarnicion"] }
    ]
  },
  {
